...
import { BookmarkPlus, RefreshCw, ScanLine } from 'lucide-react';
      ...
      <section className="hero-gradient border-b border-clinical-border">
        <div className="mx-auto max-w-5xl px-4 py-12 sm:px-6">
          <div className="max-w-2xl">
            ...
            <h1 className="mt-4 text-3xl font-bold tracking-tight text-clinical-text">
              Upload & analyze
            </h1>
            <p className="mt-3 text-clinical-muted">
              Choose a clear, well-lit image of the affected area. Results are for informational
              purposes only.
            </p>
          </div>
        </div>
