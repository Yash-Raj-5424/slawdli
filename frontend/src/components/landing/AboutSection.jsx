  ...
  return (
    <div id="about" className="scroll-mt-20">
      <div className="max-w-2xl">
        <h2 className="text-3xl font-bold text-clinical-text">About Slawdli</h2>
      ...
      <Card className="mt-10 border-teal-100 bg-teal-50/30">
        <div className="flex gap-4">
          ...
          <div>
            <h3 className="font-semibold text-clinical-text">Important disclaimer</h3>
      ...
      <section className="mt-14">
        <h3 className="text-xl font-semibold text-clinical-text">How it works</h3>
        <div className="mt-6 grid gap-6 sm:grid-cols-3">
          {STEPS.map(({ icon: Icon, title, description }, index) => (
            <Card key={title} className="relative">
              ...
              <h4 className="mt-2 font-semibold text-clinical-text">{title}</h4>
      ...
      <section id="faq" className="mt-14 scroll-mt-20">
        <h3 className="text-xl font-semibold text-clinical-text">Frequently asked questions</h3>
